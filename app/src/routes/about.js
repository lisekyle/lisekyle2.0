...
export const about = () => {
  return (
    <div className="app">
        <FullPage>
          <div className="about">
            <h4>Hi there. I'm Lise (rhymes with "please", "sleaze", and "oh, geeez"). I'm a design enigneer at <a href="http://adobe.com" target="_blank">Adobe</a>, working on Spectrum, Adobe's design system. I hail from the Midwest, which is why you'll probably think I say the word "bagel" strangely.</h4>
            <h4>I've got 4 years designing and coding with a broad range of teams and products, helping shape problems, think through solutions, and design and code beautiful user experiences.</h4>
